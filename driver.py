...
if __name__ == "__main__":
  ...
  parser.add_argument('--fappend', dest='fappend', type=str, default='hidden512', help='append this string to checkpoint filenames')
  parser.add_argument('-o', '--checkpoint_output_directory', dest='checkpoint_output_directory', type=str, default='cv/coco/hidden512/', help='output directory to write checkpoints to')
  ...
  parser.add_argument('--init_model_from', dest='init_model_from', type=str, default='cv/coco/hidden512/model_checkpoint_coco_SKP1002596MN001.local_hidden512_12.00.p', help='initialize the model parameters from some specific checkpoint?')
  ...
  parser.add_argument('--tanhC_version', dest='tanhC_version', type=int, default=1, help='use tanh version of LSTM?')
  # rnn-specific params
  parser.add_argument('--rnn_relu_encoders', dest='rnn_relu_encoders', type=int, default=1, help='relu encoders before going to RNN?')
  ...
  parser.add_argument('-b', '--batch_size', dest='batch_size', type=int, default=64, help='batch size')
  ...
  parser.add_argument('-p', '--eval_period', dest='eval_period', type=float, default=0.2, help='in units of epochs, how often do we evaluate on val set?')
